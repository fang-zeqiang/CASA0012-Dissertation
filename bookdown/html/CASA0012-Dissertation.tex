...
\begin{figure}
\includegraphics[width=1\linewidth]{/Users/fangzeqiang/Github/CASA0012-Dissertation/bookdown/general_images/LISA_den_98_18} \caption{Local Moran's I Cluster Analysis for Firm Density in England for Three Time Periods}\label{fig:fig-lisa-den}
\end{figure}
...
\addcontentsline{toc}{chapter}{Appendix B Research Report}
